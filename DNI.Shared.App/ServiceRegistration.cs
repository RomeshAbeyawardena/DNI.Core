...
namespace DNI.Shared.App
{
    public class ServiceRegistration : IServiceRegistration
    {
        ...
        {
            services
                .RegisterCryptographicCredentialsFactory<MCryptographicCredentials>((factory, cryptographyProvider) => factory.CaseWhen(Constants.PersonalDataEncryption, cryptographyProvider.GetCryptographicCredentials<MCryptographicCredentials>(KeyDerivationPrf.HMACSHA512, 
